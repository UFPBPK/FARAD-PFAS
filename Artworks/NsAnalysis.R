...
## The exposure scenario for senstive analysis: one-year exposure at the daily dose of 0.0001 mg/kg 
...
Pdata_BC$Pars[c(2,3,4,12,13,25:28)] <- c("VLC", "VMC", "VRestC", "VLC", "VKC","VLC","VKC","VMC","VRestC")
Pdata_DC$Pars[c(1:3, 12:13, 24:25)] <- c("VLC", "VMC", "VRestC", "VKC", "VRestC", "VKC","VRestC")
